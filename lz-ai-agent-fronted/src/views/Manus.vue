  ...
  <div class="chat-container">
    <div class="chat-header">
      <div class="header-left">
        ...
        <div class="app-icon manus-icon"></div>
        <h2>AI 超级智能体</h2>
      </div>
    ...
    <div class="chat-messages" ref="messagesContainer">
      <div v-for="(message, index) in messages" :key="index" :class="['message', message.isUser ? 'user-message' : 'ai-message']">
        <div v-if="!message.isUser" class="avatar ai-avatar">
          <div class="avatar-icon manus-avatar"></div>
        </div>
...
import { doChatWithManus } from '../api'
...
function sendMessage() {
  ...
  const eventSource = doChatWithManus(userMessage, chatId.value)
...
onMounted(() => {
  ...
  messages.value.push({ content: '你好！我是 AI 超级智能体，有什么可以帮助你的吗？', isUser: false })
  scrollToBottom()
})
